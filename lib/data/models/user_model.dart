...
List<UserModel> getUserModelsFromJson(String jsonString) {
  return List<UserModel>.from(
      json.decode(jsonString).map((user) => UserModel.fromJson(user)));
}

List<User> toUserEntities(List<UserModel> listUserModels) {
  return listUserModels
      .map((e) => User(name: e.name.toString(), email: e.email.toString()))
      .toList();
}
